  ...
  try {
    ...
    const template: Array<{ key: string; defaultValue: string; description: string; section: string }> = [
      ...
      },
      {
        ...
        defaultValue: "jan",
        description: "Provider: jan (local Jan/llama.cpp, default) | ollama (local) | lmstudio (local) | openai (API) | anthropic (Claude API) | sampling (MCP client) | none",
        section: "LLM Provider",
      },
      {
        key: "DREAMGRAPH_LLM_URL",
        defaultValue: "http://localhost:11434",
        description: "API base URL for explicitly selected non-Jan providers",
        section: "LLM Provider",
      },
      {
      ...
      {
        key: "DREAMGRAPH_JAN_ENABLED",
        defaultValue: "true",
        description: "Use Jan local llama.cpp first. Set false to skip Jan and use SailResearch directly.",
        section: "LLM Provider",
      },
      {
        key: "DREAMGRAPH_JAN_URL",
        defaultValue: "http://127.0.0.1:1338/v1",
        description: "Jan local OpenAI-compatible API base URL",
        section: "LLM Provider",
      },
      {
        key: "DREAMGRAPH_JAN_MODEL",
        defaultValue: "Qwen3-Coder-30B-A3B-Instruct.gguf",
        description: "Jan local model id",
        section: "LLM Provider",
      },
      {
        key: "DREAMGRAPH_SAILRESEARCH_URL",
        defaultValue: "https://api.sailresearch.com/v1",
        description: "SailResearch fallback OpenAI-compatible API base URL",
        section: "LLM Provider",
      },
      {
        key: "DREAMGRAPH_SAILRESEARCH_API_KEY",
        defaultValue: "",
        description: "SailResearch fallback API key; supply through the process environment or secret manager",
        section: "LLM Provider",
      },
      {
        key: "DREAMGRAPH_SAILRESEARCH_MODEL",
        defaultValue: "google/gemma-4-31B-it",
        description: "SailResearch fallback model id",
        section: "LLM Provider",
      },
      {
